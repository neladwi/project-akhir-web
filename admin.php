...
<body>
    ...
    <h1 style="margin-bottom: 0px; margin-top: 70px; margin-left: 660px; "><span style="color: red;">Bigetron </span>Shop</h1><br>
    <h1>Selamat datang, <?php echo $_SESSION['username']; ?></h1>
	<h2>Anda telah berhasil login sebagai Admin</h2>
  ...
  <table border="1" style="margin-bottom: 20px;">
    ...
    <tr>
      ...
      <td>
        <a href="edit_barang_admin.php?id=<?php echo $data['id_barang']; ?>" style="text-decoration: none;">Edit</a>
        <a href="delete_barang.php?id=<?php echo $data['id_barang']; ?>" onclick="return confirm('Anda yakin ingin menghapus data ini?')" style="text-decoration: none;"> | Hapus</a>
      </td>
    </tr>
    <?php } ?>
  </table>
